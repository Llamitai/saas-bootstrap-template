...
from src.tenants.application.use_cases.invitations.inviter import (
...
async def test_execute__dispatches_one_email_per_invitation(
    ...
    expect(command.context["invitation_url"].startswith(use_case.invite_base_url)).to(equal(True))
