...
def use_case(invitation_id, tenant_id, tenant_user_invitation_repository):
    tenant_user_invitation_repository.mark_expired.side_effect = lambda inv_id: TenantUserInvitation(
        uuid=inv_id,
        tenant_id=tenant_id,
        email="x@test.com",
        token="tok-abc",
...
async def test_execute__cancels_pending_invitation(
    ...
    tenant_user_invitation_repository.mark_expired.assert_called_once_with(invitation_id)
...
async def test_execute__cross_tenant_invitation_treated_as_not_found(
    ...
    tenant_user_invitation_repository.find_by_id.return_value = other_tenant_invitation
