...
from src.auth.application.use_cases.password_reset.requester import PasswordResetRequester
...
@dataclass
class MemberPasswordResetSender(UseCase):
    tenant_user_id: UUID
    tenant_id: UUID
