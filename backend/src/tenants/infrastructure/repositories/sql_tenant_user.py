...
class SQLTenantUserRepository(TenantUserRepository):
    ...
    async def count_by_status(
        ...
        stmt = (
            ...
            .where(
                TenantUserORM.tenant_id == tenant_id,
                or_(TenantUserORM.is_support.is_(False), TenantUserORM.is_support.is_(None)),
            )
    ...
    async def _filter(self, filters: TenantUserFilters, paginated: bool = False) -> Select:
        base_query = (
            ...
            .where(or_(TenantUserORM.is_support.is_(False), TenantUserORM.is_support.is_(None)))
