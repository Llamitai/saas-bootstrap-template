...
from src.tenants.application.use_cases.invitations.acceptor import InvitationAcceptor
from src.tenants.application.use_cases.invitations.getter import InvitationGetter
...
async def accept_invitation(
    ...
    session = await InvitationAcceptor(
        token=token,
