...
class BaseEnum(Enum):
    ...
    @overload
    @classmethod
    def from_value(cls, value: str | int | None, default: Self) -> Self: ...

    @overload
    @classmethod
    def from_value(cls, value: str | int | None, default: None = None) -> Self | None: ...

    @classmethod
    def from_value(cls, value: str | int | None, default: Self | None = None) -> Self | None:
        if not value:
            return default
