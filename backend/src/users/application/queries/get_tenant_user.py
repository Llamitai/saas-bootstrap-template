...
@dataclass
class GetOrCreateTenantUserHandler(QueryHandler[GetOrCreateTenantUserQuery, TenantUser]):
...
@dataclass
class GetTenantUserByIdHandler(QueryHandler[GetTenantUserByIdQuery, TenantUser | None]):
    tenant_user_repository: TenantUserRepository

    async def execute(self, query: GetTenantUserByIdQuery) -> TenantUser | None:
