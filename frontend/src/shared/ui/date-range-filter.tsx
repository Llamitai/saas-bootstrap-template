          ...
          return (
            ...
            >
              <button
                ...
                className={cn(
                  "relative z-10 flex h-8 w-8 items-center justify-center rounded-lg text-sm transition-colors duration-100",
...
export function DateRangeFilter({
  ...
  const popover = (
    <div
      ref={popoverRef}
      style={popoverStyle}
      className="overflow-hidden rounded-lg bg-popover text-popover-foreground shadow-overlay ring-1 ring-border/70"
    >
      <div className="flex items-center gap-2 px-4 pt-4 pb-2">
        <button
          type="button"
          onClick={() => navigate(-1)}
          className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="block min-w-0 max-w-55 truncate leading-5">
          {displayText}
        </span>
      </button>
