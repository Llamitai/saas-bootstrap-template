    ...
    <div className="w-64 select-none">
      ...
      <div className="flex items-center justify-between mb-4 px-1">
        <button
          ...
          className={cn(
            "p-1 rounded-lg hover:bg-accent text-muted-foreground hover:text-foreground transition-colors",
      ...
      <div className="grid grid-cols-7">
        {cells.map((day, idx) => {
          ...
          const rangeStart =
            fromTs !== null && toTs !== null && ts === Math.min(fromTs, toTs);
          const rangeEnd =
            fromTs !== null && toTs !== null && ts === Math.max(fromTs, toTs);
