  ...
  return (
    ...
    >
      <SelectTrigger
        ...
        className={cn(
          "h-8 w-auto min-w-0 gap-1 px-2 text-xs font-medium uppercase tracking-normal",
      ...
      <SelectContent align="end">
        {locales.map((loc) => (
          <SelectItem key={loc} value={loc}>
            <span className="mr-2 font-mono text-xs font-semibold uppercase tracking-normal">
              {loc.toUpperCase()}
            </span>
