...
import { onboardTenant } from "@/features/superuser/api/onboard-tenant";
import {
  useOnboardTenantWizardStore,
  type WizardStep,
} from "@/features/superuser/model/onboard-tenant-wizard-store";
import { StepInfo } from "@/features/superuser/ui/onboard-tenant/step-info";
import { StepMembers } from "@/features/superuser/ui/onboard-tenant/step-members";
import { StepVerify } from "@/features/superuser/ui/onboard-tenant/step-verify";
import { Stepper } from "@/features/superuser/ui/onboard-tenant/stepper";
      ...
      <DialogPopup className="max-w-xl p-6">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Crown className="h-4 w-4 text-warning-deep" />
            Registrar Tenant
          </DialogTitle>
          <DialogDescription>
